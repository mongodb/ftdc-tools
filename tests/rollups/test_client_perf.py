...
from performance_statistics.genny_client_ftdc import GennyClientEventsFTDCStatistics, Statistic

req_get = MagicMock()
req_get.raw = []


@patch("ftdc_tools.decode.FTDC.__iter__")
def test_ftdc_statistic(self, mock_ftdc_decoder, mock_ftdc_stream_output) -> None:
    mock_ftdc_decoder.return_value = iter(mock_ftdc_stream_output)
